import { a as useAppConfig, v as vueExports, t as tv, s as serverRenderer_cjs_prodExports, P as Primitive, aB as createSharedComposable } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const ui = vueExports.computed(() => tv({ extend: tv(theme), ...appConfig.ui?.kbd || {} }));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.4.0_@tiptap+extensions@3.22.2_@tiptap+core@3.22.2_@tiptap+pm@3.22.2__@tiptap_ff602f8142f0ba128c11c1e82cd47490/node_modules/@nuxt/ui/dist/runtime/components/Kbd.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=Kbd-T8yC2vfh.mjs.map
