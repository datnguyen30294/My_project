...
import { u as useJobTitleList, f as apiCreateJobTitle, c as apiUpdateJobTitle, d as apiDeleteJobTitle, e as apiCheckDeleteJobTitle } from './useJobTitles-DzuQHrcS.mjs';
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    const hasFilters = vueExports.computed(() => !!searchInput.value || !!selectedProjectId.value);
    ...
    const jobTitles = vueExports.computed(() => data.value?.data ?? []);
    const columns = [
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_UTable, {
              data: vueExports.unref(jobTitles),
              columns
            }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/pmc/job-titles/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-BtaR2iyc.mjs.map
