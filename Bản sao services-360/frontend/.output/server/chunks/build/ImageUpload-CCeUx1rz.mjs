...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const hasImage = vueExports.computed(() => !!displayUrl.value);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "flex items-start gap-4" }, _attrs))}><div class="size-24 rounded-lg border border-[var(--ui-border)] bg-[var(--ui-bg-muted)] flex items-center justify-center overflow-hidden shrink-0">`);
      if (vueExports.unref(displayUrl)) {
        _push(`<img${serverRenderer_cjs_prodExports.ssrRenderAttr("src", vueExports.unref(displayUrl))}${serverRenderer_cjs_prodExports.ssrRenderAttr("alt", __props.alt)} class="size-full object-cover">`);
      } else {
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_UButton, {
        ...
        label: vueExports.unref(hasImage) ? "Đổi ảnh" : "Tải ảnh lên",
        variant: "outline",
        size: "sm",
        loading: __props.loading,
        onClick: openFilePicker
      }, null, _parent));
      if (vueExports.unref(hasImage)) {
        _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_UButton, {
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_UModal, {
        ...
        body: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p${_scopeId}>Bạn có chắc chắn muốn xóa ảnh này không?</p>`);
          } else {
            return [
              vueExports.createVNode("p", null, "Bạn có chắc chắn muốn xóa ảnh này không?")
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/shared/image/ImageUpload.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_5 = Object.assign(_sfc_main, { __name: "SharedImageUpload" });

export { __nuxt_component_5 as _ };
//# sourceMappingURL=ImageUpload-CCeUx1rz.mjs.map
