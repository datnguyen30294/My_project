...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  __name: "chinh-sach-bao-mat",
  __ssrInlineRender: true,
  setup(__props) {
    useSeoMeta({
      title: "Chính sách bảo mật - Thần Nông",
      description: "Chính sách bảo mật thông tin của Thần Nông."
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_LandingPolicyPage, vueExports.mergeProps({
        "policy-type": ("POLICY_TYPES" in _ctx ? _ctx.POLICY_TYPES : vueExports.unref(POLICY_TYPES)).PRIVACY_POLICY
      }, _attrs), null, _parent));
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/chinh-sach-bao-mat.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=chinh-sach-bao-mat-CuMjCgLz.mjs.map
