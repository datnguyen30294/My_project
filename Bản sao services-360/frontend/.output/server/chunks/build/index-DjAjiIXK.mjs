...
import { _ as __nuxt_component_10$1 } from './ServiceCategoryFormModal-D4Mg27H6.mjs';
...
import { d as useServiceCategoryList, q as apiCreateServiceCategory, n as apiUpdateServiceCategory, o as apiDeleteServiceCategory, p as apiCheckDeleteServiceCategory } from './useCatalogItems-Db1MWi3b.mjs';
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    const categories = vueExports.computed(() => data.value?.data ?? []);
    const columns = [
      { id: "image", header: "Ảnh" },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_CatalogServiceCategoryFormModal = __nuxt_component_10$1;
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_UTable, {
              data: vueExports.unref(categories),
              columns
            }, {
              "image-cell": vueExports.withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="size-10 rounded-lg border border-[var(--ui-border)] bg-[var(--ui-bg-muted)] flex items-center justify-center overflow-hidden"${_scopeId2}>`);
                  if (row.original.image_url) {
                    _push3(`<img${serverRenderer_cjs_prodExports.ssrRenderAttr("src", row.original.image_url)}${serverRenderer_cjs_prodExports.ssrRenderAttr("alt", row.original.name)} class="size-full object-cover"${_scopeId2}>`);
                  } else {
                  ...
                  return [
                    vueExports.createVNode("div", { class: "size-10 rounded-lg border border-[var(--ui-border)] bg-[var(--ui-bg-muted)] flex items-center justify-center overflow-hidden" }, [
                      row.original.image_url ? (vueExports.openBlock(), vueExports.createBlock("img", {
                        key: 0,
              ...
              "items_count-cell": vueExports.withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${serverRenderer_cjs_prodExports.ssrInterpolate(row.original.items_count ?? 0)}`);
                } else {
                  return [
                    vueExports.createTextVNode(vueExports.toDisplayString(row.original.items_count ?? 0), 1)
                  ];
                }
              }),
            ...
            return [
              vueExports.createVNode("div", { class: "bg-white border border-border-gray rounded-xl overflow-hidden shadow-sm" }, [
                vueExports.createVNode(_component_UTable, {
                  ...
                  "items_count-cell": vueExports.withCtx(({ row }) => [
                    vueExports.createTextVNode(vueExports.toDisplayString(row.original.items_count ?? 0), 1)
                  ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/pmc/catalog/categories/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-DjAjiIXK.mjs.map
