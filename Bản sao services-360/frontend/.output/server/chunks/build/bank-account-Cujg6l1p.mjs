...
import { v as vueExports, u as useSeoMeta, j as useToast, s as serverRenderer_cjs_prodExports, l as _sfc_main$c, ay as usePlatformApiFetch, aD as $platformApi } from './server.mjs';
...
import { p as parseBankAccountSettings } from './useSettings-Bc7XNrjh.mjs';
...
function usePlatformSettingsGroup(group) {
  return usePlatformApiFetch(
    vueExports.computed(() => `/platform/settings/${vueExports.toValue(group)}`),
    { watch: [() => vueExports.toValue(group)] }
  );
}
function apiSavePlatformSettings(group, settings) {
  return $platformApi(`/platform/settings/${group}`, {
    method: "PUT",
    body: { settings }
  });
}
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/platform/settings/bank-account.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=bank-account-Cujg6l1p.mjs.map
