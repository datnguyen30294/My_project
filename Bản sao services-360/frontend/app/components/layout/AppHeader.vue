      ...
      >
        ...
        >
          ...
          <img
            ...
            :src="user.avatar_url"
            :alt="user.name"
            class="size-9 rounded-full object-cover border-2 border-slate-200 flex-shrink-0"
          >
          <div
            v-else
            class="size-9 rounded-full bg-[#0f0f29] flex items-center justify-center text-white text-[14px] font-semibold flex-shrink-0"
          >
