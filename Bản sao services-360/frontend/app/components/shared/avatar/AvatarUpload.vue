...
// Reset internal state when currentUrl changes (e.g. parent refreshed data)
  ...
  <div class="flex items-center gap-4">
    ...
    <div class="flex gap-2">
      <UButton
        ...
        :label="hasAvatar ? 'Đổi ảnh' : 'Tải ảnh lên'"
        variant="outline"
        size="sm"
        :loading="loading"
    ...
    >
      <template #body>
        <p>Bạn có chắc chắn muốn xóa ảnh đại diện không?</p>
      </template>
      <template #footer>
