...
class OgTicketRepository extends BaseRepository
{
     ...
     *
     * @param  list<int>  $accountIds
     * @return Collection<int, object{ticket_id: int, project_id: int|null, status: string, completed_at: string|null, account_id: int, assigned_at: string, subject: string, priority: string}>
     */
    public function activeForAccountsInRange(array $accountIds, string $from, string $to): Collection
    {
        if ($accountIds === []) {
            /** @var Collection<int, object{ticket_id: int, project_id: int|null, status: string, completed_at: string|null, account_id: int, assigned_at: string, subject: string, priority: string}> */
            return new Collection;
        }
