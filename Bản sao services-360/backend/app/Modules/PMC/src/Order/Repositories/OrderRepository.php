...
class OrderRepository extends BaseRepository
{
    ...
    /**
     * Đơn `completed` trong [from, to] (theo `completed_at`), kèm ticket (dự án +
     * đánh giá cư dân) và phí nền tảng đã đóng băng — phục vụ gom số liệu OG theo
     * dự án cho báo cáo sức khỏe tenant.
     *
     * @return Collection<int, Order>
     */
    public function completedInRangeWithProject(CarbonInterface $from, CarbonInterface $to): Collection
    {
        return $this->newQuery()
            ...
            ->with([
                ...
                'quote.ogTicket:id,project_id,resident_rating',
                'quote.ogTicket.project:id,name',
                'closingPeriodOrder:id,order_id,frozen_platform_fee',
            ])
            ->get(['id', 'quote_id', 'total_amount', 'completed_at']);
    }
