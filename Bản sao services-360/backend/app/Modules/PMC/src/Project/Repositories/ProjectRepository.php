...
class ProjectRepository extends BaseRepository
{
    ...
    /**
     * Whether a project with the given code already exists in the current
     * tenant schema (codes are unique per tenant, not globally).
     */
    ...
    /**
     * All projects in the current tenant schema, non-paginated, sorted by name.
     * Used by the platform console to merge projects across every tenant.
     *
     * @return \Illuminate\Database\Eloquent\Collection<int, Project>
     */
    public function allSortedByName(): \Illuminate\Database\Eloquent\Collection
    {
        return $this->newQuery()->orderBy('name')->orderBy('id')->get();
    }
