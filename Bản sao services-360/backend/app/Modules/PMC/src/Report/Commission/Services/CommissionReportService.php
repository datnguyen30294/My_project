...
class CommissionReportService extends BaseService implements CommissionReportServiceInterface
{
    public function __construct(
        protected CommissionReportRepository $repository,
    ...
    public function getSummary(array $filters): array
    {
        ...
        // Lọc theo một dự án → hiển thị phí nền tảng override của dự án đó;
        // báo cáo gộp nhiều dự án → mặc định tenant.
        ...
        return [
            ...
            'platform_rules' => [
                ...
                'fixed_per_order' => $feePolicy?->appliedFixed() ?? 0.0,
            ],
        ];
    }
