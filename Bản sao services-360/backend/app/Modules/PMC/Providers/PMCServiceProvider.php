...
use App\Modules\PMC\Account\ExternalServices\Platform\TenantAccountExternalService;
...
use App\Modules\PMC\Commission\ExternalServices\Platform\CommissionRebalanceExternalService;
...
use App\Modules\PMC\Customer\ExternalServices\Platform\TenantCustomerCountExternalService;
...
use App\Modules\PMC\OgTicket\ExternalServices\Platform\TenantResidentRatingExternalService;
...
use App\Modules\PMC\Order\ExternalServices\Platform\TenantBusinessSummaryExternalService;
use App\Modules\PMC\Order\ExternalServices\Platform\TenantBusinessSummaryExternalServiceInterface;
use App\Modules\PMC\Order\ExternalServices\Platform\TenantProjectOrderExternalService;
...
use App\Modules\PMC\Project\ExternalServices\Platform\PlatformProjectDirectoryExternalService;
...
use App\Modules\PMC\Project\Observers\ProjectObserver;
...
use App\Modules\PMC\Report\VendorOrder\Services\VendorOrderReportService;
...
class PMCServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(TenantProjectExternalServiceInterface::class, TenantProjectExternalService::class);
        $this->app->bind(PlatformProjectDirectoryExternalServiceInterface::class, PlatformProjectDirectoryExternalService::class);
        $this->app->bind(DefaultRoleServiceInterface::class, DefaultRoleService::class);
        $this->app->bind(RoleServiceInterface::class, RoleService::class);
        $this->app->bind(AuthServiceInterface::class, AuthService::class);
        $this->app->bind(AccountServiceInterface::class, AccountService::class);
        $this->app->bind(TenantAccountExternalServiceInterface::class, TenantAccountExternalService::class);
        ...
        $this->app->bind(TenantResidentRatingExternalServiceInterface::class, TenantResidentRatingExternalService::class);
        $this->app->bind(QuoteServiceInterface::class, QuoteService::class);
        $this->app->bind(OrderServiceInterface::class, OrderService::class);
        $this->app->bind(TenantBusinessSummaryExternalServiceInterface::class, TenantBusinessSummaryExternalService::class);
        $this->app->bind(TenantProjectOrderExternalServiceInterface::class, TenantProjectOrderExternalService::class);
        ...
        $this->app->bind(CommissionRebalanceExternalServiceInterface::class, CommissionRebalanceExternalService::class);
        ...
        $this->app->bind(VendorOrderReportServiceInterface::class, VendorOrderReportService::class);
        $this->app->bind(AcceptanceReportServiceInterface::class, AcceptanceReportService::class);
        $this->app->bind(CustomerServiceInterface::class, CustomerService::class);
        $this->app->bind(TenantCustomerCountExternalServiceInterface::class, TenantCustomerCountExternalService::class);
    ...
    protected function loadRoutes(): void
    {
        Route::prefix('api/v1/pmc')
            ->middleware(['api', 'tenant', 'tenant.active', 'tenant.module', 'auth:sanctum'])
            ->group(base_path('app/Modules/PMC/routes/api.php'));

        Route::prefix('api/v1/auth')
            ->middleware(['api', 'tenant', 'tenant.active'])
        ...
        Route::prefix('api/v1/ext')
            ->middleware(['api', 'tenant', 'tenant.active', 'auth.api-client'])
