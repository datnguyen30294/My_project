...
class CommissionOverrideTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        parent::setUp();
        $this->actingAsAdmin();
        // Platform fee = 1000đ + 5% (the project's platform cut). Tests have no real
        // tenant, so bind a fake fee policy that drives the "Platform" amount.
    ...
    public function test_can_override_completed_order(): void
    {
        // Đơn đã hoàn thành nhưng CHƯA bị khóa tài chính (chưa vào kỳ đã chốt)
        // vẫn được điều chỉnh hoa hồng — chốt chặn thật sự là isFinanciallyLocked.
