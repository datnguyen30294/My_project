...
use App\Modules\PMC\Report\VendorOrder\Controllers\VendorOrderReportController;
...
Route::prefix('reports')->group(function (): void {
    ...
    Route::prefix('vendor-order')->group(function (): void {
        Route::get('/summary', [VendorOrderReportController::class, 'summary']);
        Route::get('/by-vendor', [VendorOrderReportController::class, 'byVendor']);
        Route::get('/by-project', [VendorOrderReportController::class, 'byProject']);
        Route::get('/trend', [VendorOrderReportController::class, 'trend']);
    });
});
