...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        $middleware->alias([
            ...
            'tenant.active' => \App\Modules\Platform\Tenant\Middleware\EnsureTenantActive::class,
            'tenant.module' => \App\Modules\PMC\Middleware\EnsureModuleEnabled::class,
            'tenant.portal' => \App\Modules\Platform\Tenant\Middleware\EnsureTenantPortalEnabled::class,
            ...
            'tenant.vendor_enabled' => \App\Modules\Marketplace\Partner\Http\Middleware\EnsureTenantVendorEnabled::class,
        ]);
